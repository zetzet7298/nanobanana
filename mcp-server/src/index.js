...
class NanoBananaServer {
    ...
    constructor() {
        ...
        try {
            ...
            this.imageEnhancer = new ImageEnhancer(authConfig, this.enhancementConfig);
        }
        catch (error) {
        ...
        this.server.setRequestHandler(ListToolsRequestSchema, async () => {
            return {
                tools: [
                    ...
                    {
                        name: "enhance_image",
                        description: "Enhance images using AI analysis. Supports single file, multiple files, or recursive directory processing. Uses configurable presets for different business types (tourism, restaurant, hotel, e-commerce).",
                        inputSchema: {
                            type: "object",
                            properties: {
                                input: {
                                    type: "string",
                                    description: "Path to image file or directory. Supports absolute or relative paths.",
                                },
                                output: {
                                    type: "string",
                                    description: "Optional output directory. Defaults to nanobanana-output/",
                                },
                                preset: {
                                    type: "string",
                                    description: "Enhancement preset to use: default, tourism, restaurant, hotel, ecommerce",
                                    default: "default",
                                },
                                recursive: {
                                    type: "boolean",
                                    description: "If input is a directory, process subdirectories recursively",
                                    default: false,
                                },
                                analyzeOnly: {
                                    type: "boolean",
                                    description: "Only analyze images without enhancement (faster, saves analysis reports)",
                                    default: false,
                                },
                                preview: {
                                    type: "boolean",
                                    description: "Automatically open enhanced images in default viewer",
                                    default: false,
                                },
                            },
                            required: ["input"],
                    ...
                    {
                        name: "analyze_image",
                        description: "Analyze images using AI to get detailed descriptions. Returns JSON analysis including subject, context, colors, composition, mood, and improvement suggestions.",
                        inputSchema: {
                            type: "object",
                            properties: {
                                input: {
                                ...
                                preset: {
                                    type: "string",
                                    description: "Analysis preset to use: default, tourism, restaurant, hotel, ecommerce",
                                    default: "default",
                                },
                                recursive: {
                                    type: "boolean",
                                    description: "If input is a directory, analyze subdirectories recursively",
                                    default: false,
                                },
                            },
                            required: ["input"],
                    ...
                    },
                    {
                        ...
                        description: "List all available image enhancement presets with their descriptions",
                        inputSchema: {
                            type: "object",
                            properties: {},
                        },
            ...
            try {
                ...
                switch (name) {
                    ...
                    case "list_enhancement_presets": {
                        const presets = Object.entries(this.enhancementConfig.presets).map(([key, preset]) => `• **${key}**: ${preset.name}\n  ${preset.description}`);
                        return {
                            content: [
                                {
                                    type: "text",
